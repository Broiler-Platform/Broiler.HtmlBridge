...
/// which one it uses.
/// <para>
/// This is the half of JSEAL a conformance suite depends on before it can assert anything — the
...
public class JsealRegistryTests
{
    ...
    /// </remarks>
    static JsealRegistryTests() => JsEngineHosting.EnsureRegistered();
    ...
    public void SetDefaultRefusesANameNobodyRegistered()
    {
        ...
        // happened to register first — which is the failure mode the argument check exists to stop.
