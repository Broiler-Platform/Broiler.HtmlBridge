...
public class OptionTextTests
{
    ...
    /// <summary>
    /// The same public-surface read <see cref="NodeTreeIdentityTests"/> uses, with a throw written to
    /// <c>#out</c> as <see cref="NodeRelationshipCanonicalTests"/> does: a member that is missing or
    /// throws would otherwise leave <c>#out</c> empty, with no word of where.
    /// </summary>
