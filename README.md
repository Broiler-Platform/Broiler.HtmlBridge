...
[docs/jseal.md](https://github.com/Broiler-Platform/Broiler.HtmlBridge/blob/main/docs/jseal.md).
...
- [docs/jseal.md](https://github.com/Broiler-Platform/Broiler.HtmlBridge/blob/main/docs/jseal.md) — engine neutrality, the contracts, the providers, the
  budget.
- [docs/script-initiated-navigation.md](https://github.com/Broiler-Platform/Broiler.HtmlBridge/blob/main/docs/script-initiated-navigation.md) — how a
  script's navigation reaches the host.

## License

Apache-2.0. See [LICENSE](https://github.com/Broiler-Platform/Broiler.HtmlBridge/blob/main/LICENSE) and [THIRD_PARTY_NOTICES.md](https://github.com/Broiler-Platform/Broiler.HtmlBridge/blob/main/THIRD_PARTY_NOTICES.md).
