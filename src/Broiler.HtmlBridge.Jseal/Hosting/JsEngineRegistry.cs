...
/// provider needs two in one process. And a bisect — "does this page render differently on the other
/// engine?" — is a question about a run, not about a build.
/// </para>
/// <para>
...
public static class JsEngineRegistry
{
    ...
    /// <summary>
    /// Drops every registration. For test isolation only — a suite that registers a substitute
