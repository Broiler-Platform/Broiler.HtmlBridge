namespace Broiler.HtmlBridge.Jseal.Providers;
...
/// a provider can be written outside this repository — a JSEAL whose only possible implementations are
/// the two assemblies next to it would be a naming exercise rather than an abstraction — and it lives
