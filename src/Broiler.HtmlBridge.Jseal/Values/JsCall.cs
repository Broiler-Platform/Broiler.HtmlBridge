...
/// in, and — for a construct call — <c>new.target</c>.
/// </summary>
/// <remarks>
/// <para>
...
/// compiler can see — and it would do so in code migrated file-by-file, where a missing realm is
...
/// frame and hands a span of it here. That keeps the shape of Broiler.JS's <c>in Arguments</c> — which
/// is itself a readonly struct with four inline slots — while being expressible by a provider whose
