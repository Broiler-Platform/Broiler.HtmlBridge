...
internal static class EventHandlerReflectorBinding
{
    ...
    /// </summary>
    /// <remarks>
    /// <c>IsFunction</c> is decided from the handle without entering the engine — the provider
    /// answered it once, when it filled the call frame, which is why the kind is on the handle at
