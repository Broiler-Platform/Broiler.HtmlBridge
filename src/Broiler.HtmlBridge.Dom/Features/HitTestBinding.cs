...
/// <c>document.elementsFromPoint</c> — co-located as an HtmlBridge feature module.
...
/// both through the realm. <see cref="Coordinate"/> coerces through the realm because
/// <c>elementFromPoint("10", "20")</c> is a page passing strings.
/// </remarks>
