...
/// <summary>
/// A listener registration with identity independent of its callback and options.
/// Dispatch snapshots share its removal state; re-adding a callback creates a new registration.
/// </summary>
internal sealed class EventListenerRegistration(JsValue listener, bool capture, bool once = false, bool passive = false)
{
    public JsValue Listener { get; } = listener;
