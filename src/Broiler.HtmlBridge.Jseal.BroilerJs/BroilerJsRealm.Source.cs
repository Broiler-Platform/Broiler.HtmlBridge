...
internal sealed partial class BroilerJsRealm
{
    ...
    /// specification one.</b> It used to sit in the shared helper, so every member forced it — the
    ...
    /// this realm is not forced strict — an inserted script element or a frame's, on that same page —
